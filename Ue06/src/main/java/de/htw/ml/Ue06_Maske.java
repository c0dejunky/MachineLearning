...
public class Ue06_Maske extends Application {
...
//		FloatMatrix credit = FloatMatrix.loadCSVFile("german_credit_jblas.csv");
		...
		Dataset s = new Dataset("german_credit_jblas.csv");
		s.splitData(0.9f);
		FloatMatrix values = s.getTrain();
		...
		int lastColumnIndex = values.columns;
		FloatMatrix orgY = values.getColumn(0);
